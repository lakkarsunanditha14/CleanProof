...
async def resolve_complaint(
    ...
    resolution = Resolution(
        ...
        gemini_is_resolved=verification_result["gemini_is_resolved"],
        gemini_confidence=verification_result["gemini_confidence"],
        gemini_explanation=verification_result["gemini_explanation"],
        gemini_status=verification_result["gemini_status"],
